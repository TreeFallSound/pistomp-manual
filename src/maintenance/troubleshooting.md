...
| Possible cause | Try |
|----------------|-----|
| Overworked CPU | In MOD-UI, check CPU meter and XRUN count. Increase the JACK period size (see [Performance Tuning]({{ '/maintenance/performance/' | url }})) or remove plugins |
