...
- **Navigation encoder (leftmost)** — scroll and click to navigate the LCD, long-press for deep edit mode and system menu.
- **Tweak 1** — sends MIDI CC 70 on rotation, click to confirm a setting.
- **Tweak 2** — sends MIDI CC 71 on rotation, click to confirm a setting.
